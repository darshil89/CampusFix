  ...
  return (
    <section class="text-blueGray-700 bg-white mt-20">
      <div class="container flex flex-col items-center mx-auto md:flex-row ">
        <div class="w-full lg:w-5/6 lg:max-w-lg mb-16 md:w-1/2 md:pr-24 xl:mr-20">
          <img
        ...
        <div class="flex flex-col items-start w-full pt-0  text-left lg:flex-grow md:w-1/2   md:mb-0">
